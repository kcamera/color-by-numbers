...
| Safety | No destructive actions in kid space: continuous autosave, generous undo. "Color it again" feels like reset but archives the prior non-empty attempt invisibly (ring buffer of ~3/picture; empty resets are no-ops; Workshop restores or prunes) — amended at M3, see DESIGN.md |
